...
namespace Recognissimo.Components
{
    ...
    public sealed class SpeechRecognizer : SpeechProcessor
    {
        ...
        /// <summary>
        /// When true, each vocabulary entry is treated as a separate phrase in the grammar.
        /// This provides more accurate partial results that reflect only the words actually spoken.
        /// When false (default), all vocabulary entries are combined into a single phrase,
        /// which gives stronger bias toward the intended commands but may produce predictive partial results.
        /// 
        /// Use true for applications requiring precise partial result feedback.
        /// Use false for reliable command recognition with tolerance for unclear pronunciation.
        /// </summary>
        public bool SeparateVocabularyEntries
        {
            get => settings.separateVocabularyEntries;
            set => settings.separateVocabularyEntries = value;
        }
        ...
        {
            var separator = settings.separateVocabularyEntries ? "\", \"" : " ";
