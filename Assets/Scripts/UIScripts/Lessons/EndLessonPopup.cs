...
{
    public class EndLessonPopup : MonoBehaviour
    {
        [Header("Texts")]
        ...
        public void Init(LessonCompletionResult result, Action onRestart, Action onExit)
        {
            ...
            Debug.Log($"EndLessonPopup: correct={result.CorrectAnswers}, total={result.TotalQuestions}");
        }
        ...
        private static void SetRewardSlot(GameObject slotObject, Image slotIcon, TMP_Text slotText, ItemDefinition item)
        {
