...
{
    public class ImageMathsQuestionView : MonoBehaviour
    {
        [Header("Header")]
        ...
        private readonly List<ImageMathsQuestionDefinition> _sessionQuestions = new List<ImageMathsQuestionDefinition>();
        ...
        public void Init(string lessonHeadline, ImageMathsQuestionSet questionSet, int questionsPerSession, Action<int, int> onCompleted, Action onBackRequested)
        {
            ...
            {
                Debug.LogWarning("ImageMathsQuestionView: question set is empty.");
        ...
        private void BuildSessionQuestions(IReadOnlyList<ImageMathsQuestionDefinition> source, int targetCount)
        {
        ...
        private void RenderCurrentQuestion()
        {
            ...
            ImageMathsQuestionDefinition current = _sessionQuestions[_currentQuestionIndex];

            if (questionImage != null)
            {
                questionImage.sprite = current.QuestionImage;
                questionImage.enabled = current.QuestionImage != null;
            }
